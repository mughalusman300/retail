...
class FPDF
{
    ...
    function __construct($params = array())
    {
        ...
        if (defined('FPDF_FONTPATH')) {
            ...
            $this->fontpath = '';
        // Core fonts
        $this->CoreFonts = array('courier', 'helvetica', 'times', 'symbol', 'zapfdingbats', 'calibri', 'calibrib');
        // Scale factor
        if ($unit == 'pt')
            $this->k = 1;
        elseif ($unit == 'mm')
        ...
        // Page sizes
        $this->StdPageSizes = array('a3' => array(841.89, 1190.55), 'a4' => array(595.28, 841.89), 'a5' => array(420.94, 595.28), 'letter' => array(612, 792), 'legal' => array(612, 1008), 'labels' => array(50, 340), 'package' => array(105, 340), 'rolls' => array(48, 295), 'custom' => array(82, 255));
