        ...
        if (!empty($products)) {
            ...
            foreach ($products as $row) {
                ...
                if ($row->v1 != '' || $row->v2 != '' || $row->v3 != '') {
                    ...
                    if ($row->v1 != '') {
                        $variation_arr[] = '<span class="text-theme" style="font-weight:600">'. $variants['v1'] .'</span>: '. $row->v1;
                    }
                    if ($row->v2 != '') {
                        $variation_arr[] = '<span class="text-theme" style="font-weight:600">'. $variants['v2'] .'</span>: '. $row->v2;
                    }
                    if ($row->v3 != '') {
                        $variation_arr[] = '<span class="text-theme" style="font-weight:600">'. $variants['v3'] .'</span>: '. $row->v3;
                    }
